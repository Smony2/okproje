                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Yönetici Düzenle <a style="float: right" href="{{ route('avukat.yoneticiler.index') }}"
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('avukat.yoneticiler.update', $admin->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                ...
                                <button type="submit" class="btn btn-primary waves-effect waves-light">Yöneticiyi
                                    Güncelle
                                </button>
