        ...
        <div class="col-md-8">
            <div class="card shadow-sm">
                <div class="card-header">
                    <h6 class="mb-0">Yeni Avukat Ekle</h6>
                </div>
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('admin.avukatlar.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="baro_no" class="form-control" value="{{ old('baro_no') }}">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Baro Adı</label>
                                <input type="text" name="baro_adi" class="form-control" value="{{ old('baro_adi') }}">
                            </div>
                            <div class="col-md-6">
