        ...
        <div class="col-md-12">
            <div class="card shadow-sm">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h6 class="mb-0">Avatarlar</h6>
                    <a href="{{ route('admin.avatarlar.create') }}"
                                ...
                                <div class="col-md-2 mb-4">
                                    <div class="border rounded p-2 h-100 d-flex flex-column">
                                        ...
                                        <div class="d-flex justify-content-center gap-2 mb-20">
                                            <a href="{{ route('admin.avatarlar.edit', $avatar->id) }}"
                                               class="btn btn-sm btn-info">Düzenle</a>
                                            <form action="{{ route('admin.avatarlar.destroy', $avatar->id) }}"
                                                  method="POST"
