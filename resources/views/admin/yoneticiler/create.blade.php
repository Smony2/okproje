                ...
                <div class="col-12">
                    <div class="card m-b-20">
                        <div class="card-header">
                            <h4>Yönetici Ekle     <a style="float: right" href="{{ route('admin.yoneticiler.index') }}" class="btn btn-ekle waves-effect waves-light">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('admin.yoneticiler.store') }}" method="POST">
                                ...
                                <button type="submit" class="btn btn-primary waves-effect waves-light">Yönetici Ekle</button>
